            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a href="csv_student.php">Student</a>
                        </li>
                        <li>
                            <a href="Add_faculty_detail.php"></i>Faculty</a>
                        </li>
                        <li>
                            ...
                            if (in_array($extension, $allowed_extension)) { //check selected file extension is present in allowed extension array
                                ...
                                foreach ($objPHPExcel->getWorksheetIterator() as $worksheet) {
                                    ...
                                    for ($row = 2; $row <= $highestRow; $row++) {
                                        ...
                                        $eno = mysqli_real_escape_string($connect, $worksheet->getCellByColumnAndRow(0, $row)->getValue());
                                        ...
                                        $contact = mysqli_real_escape_string($connect, $worksheet->getCellByColumnAndRow(3, $row)->getValue());
                                        $email = mysqli_real_escape_string($connect, $worksheet->getCellByColumnAndRow(4, $row)->getValue());
                                        $year=substr($eno, 0, 4);
                                        
                                        
                                         $query1 = "insert into tbl_user (username,password,u_type) values ('$eno','qwerty','1')";
                                        $query = "insert into tbl_student_detail (enrollment_no,s_name,s_address,s_contact,s_email,year,uid,status) values ('$eno','$name','$address','$contact','$email','$year',LAST_INSERT_ID(),'Active')";
